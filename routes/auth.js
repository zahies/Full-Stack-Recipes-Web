...
router.post('/register', async (req, res) => {
    try{
        ...
        DB.execQuery(`INSERT INTO [dbo].[users] (Username, FirstName, LastName, Country, Password, Email, ProfilePic) VALUES ('${req.body.user_name}','${req.body.first_name}','${req.body.last_name}','${req.body.country}','${req.body.password}','${req.body.email}','${req.body.photo_url}')`)
